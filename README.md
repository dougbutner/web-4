...
You can see that this example used only web 2 technology, as JWT doesn't imply decentralized use. This w, but the ability to do this is  begs the question:
