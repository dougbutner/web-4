...
You can see that this example used only **web 2 technology**, as JWT doesn't imply decentralized used. We have said we four is based on web 3 (blockchain,  but the ability to do this is  begs the question:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTI5NjE3MjgwNSwtMTA1MDMxMTE5MywxND
