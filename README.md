...
We have said we four is based on web 3 (blockchain), but this example used only **web 2 technology**, as JWT doesn't imply decentralized used.  so this information should in stead be stored in a smart contract.

 but the ability to do this is at all begs the question:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTg3NjY1NzYzOCwtMTA1MDMxMTE5MywxND
