...
A geo-social layer is something that affects people (**social**) at a given bounded area (**geo**). These layers can be nested, with a finite number of smaller areas making up the larger area, or overlapping, such as in cl. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzM0ODg3MjA3LDExMTk2MjM1MTQsMTk3Mj
