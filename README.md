...
A geo-social layer is something that affects people (**social**) at a given bounded area (**geo**). Typically, these layers are nested, with a finite number of smaller areas making up the larger area, and so on. 

An example is the governing body of an area, including all of the legislation and officials. A corporate example is the sales representatives for a certain area of the country. A civilian example is regional spelling bees that filter to national and international 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTI0NDIwMDcyMSwxMTE5NjIzNTE0LDE5Nz
